...
if equation_choice == "Custom Equation":
    equation_input = st.sidebar.text_area("Enter your custom equation as a function of x:")
    # For simplicity, we assume it's a lambda function (e.g., `lambda x: x**2`)
    try:
        func = eval("lambda x: " + equation_input)
    except:
